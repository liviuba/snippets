package liviu.examples.annoyanator;
...
public class Annoyanator extends Activity{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		startTheSpam.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v){
				...
				Intent intent = new Intent(Annoyanator.this, AnnoyanatorService.class);
				intent.putExtra("phoneNumber",phoneNumber);
				intent.putExtra("smsMessage",smsMessage);
			
				PendingIntent pintent = PendingIntent.getService(Annoyanator.this, 0, intent, 0);
